  ...
  return (
    <>
      <div className="flex justify-center md:items-center h-screen bg-[url('/public/bgnew.svg')] ">
        <div className="bg-white md:flex md:justify-between md:p-10 p-6 md:h-2/3 mt-[15%] md:mt-0 md:min-h-0 md:w-2/3 w-[80%] min-h-fit max-h-[83%] overflow-y-scroll rounded-xl shadow-lg ">
          {loading ? (
