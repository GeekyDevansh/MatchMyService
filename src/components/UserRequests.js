            ...
            <div className="md:w-[60%] flex justify-center items-center ">
              <div className="flex flex-col gap-10">
                <div className="md:text-xl text-lg font-medium md:text-right ">
                  ...
                  <span className="font-black">Delete</span> the service
                  request?
                </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4 items-center ">
                      ...
                      <div
                        className={`${
                          darkMode ? "bg-gray-200" : "bg-[#f8f9fb]"
                        } rounded-2xl`}
                      >
                        <div className="text-center text-lg font-extrabold border-b border-black border-dashed text-black p-3 mx-5 ">
                          Requirement
                        </div>
                        <div
                          className={`text-gray-900 rounded-xl border-white p-4  font-medium w-full`}
                        >
                      ...
                      e?.bidding_info?.map((element) => {
                        return (
                          <div>
                            ...
                            >
                              <div
                                className={` bg-gradient-to-r from-[#ffffff] to-[#8a9cd6] flex justify-between w-full text-gray-900 rounded-t-xl md:px-6 px-4 md:py-3 py-2 mt-5 md:text-lg text-center `}
                              >
