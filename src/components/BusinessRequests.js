...
const BusinessRequests = ({ darkMode }) => {
          ...
          data?.map((e, i) => {
            return (
              ...
              >
               ...
               {e.bidding===true && <div className={`flex justify-between text-gray-900 ${darkMode?"bg-white":"bg-[#E8E8E8]"} rounded-xl px-6 py-3 mt-5 md:text-lg `} >
                ...
                <div className="flex justify-between" >
                    ...
                    <div className="w-1/2" >
                        <input type="text" id="ip" placeholder="Bid Amount" onChange={(e)=>setBiddingPrice(e.target.value)} className=" rounded-lg px-3 py-3 mt-5 w-full text-gray-900 font-semibold border-2 border-gray-800 " />
                    </div>
                    <button onClick={()=>handleClick(e.id)} className="bg-blue-500 rounded-lg px-8 py-3 mt-5 hover:bg-blue-700 text-white" >
                        Bid
                    </button>
