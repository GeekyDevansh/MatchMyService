        ...
        createUserWithEmailAndPassword(auth, data.email, data.password)
          .then(async (res) => {
            ...
            await updateProfile(newUser, {
              ...
              photoURL: data.serviceType || serviceName,
            });
            return res;
          })
          .then((res) => {
        ...
        >
            ...
            <div className="flex justify-center items-center gap-2 px-2">
              <div>
                <button
                  ...
                  } bg-[#E8E8E8] rounded-xl md:w-18 md:h-18 w-16 h-16`}
                  onClick={() => {
          ...
          <div className={`gap-1 flex mt-4`}>
            ...
            >
              <div className="flex">
                <input
                  ...
                  className={`p-3 bg-gray-200 rounded-l-xl text-gray-900 focus:outline-0 ${
                    serviceType === "other" ? "w-full" : "w-[95%]"
                  } md:w-[80%] md:ml-12 ${
                    serviceType === "other" ? "ml-1" : "ml-0"
                  } `}
                  {...register("password")}
                />
                <div
                  className=" text-2xl cursor-pointer bg-gray-200 text-gray-500 p-3 rounded-r-xl items-center justify-center flex"
                  onClick={() => {
            ...
            <div
              className={`md:w-1/3 w-[80%]  ${
                serviceType === "other" ? "hidden" : "block"
              }`}
            >
              <button
                type="submit"
            ...
            <div
              className={`  ${serviceType === "other" ? "block" : "hidden"}`}
            >
              <input
                type="text"
                name="service_name"
          ...
          <div
            className={`w-full items-center justify-center flex mt-4 ${
              serviceType === "other" ? "block" : "hidden"
            }`}
          >
            <button
              type="submit"
